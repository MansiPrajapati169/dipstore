...
data class SellData(
    ...
    companion object {
        fun getSellData(context: Context): ArrayList<SellData> {
            val sellList: ArrayList<SellData> = ArrayList()
            sellList.add(SellData(R.drawable.sell_first,"Basic High Dpstr", context.getString(R.string.price),"$25.90",false))
